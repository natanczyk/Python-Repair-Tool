# Test suite for wrong_easy_037  (slug: next-greater-element-i)
import importlib.util, pathlib

_wrong_path = (
    pathlib.Path(__file__).parent.parent
    / 'question_easy' / 'code' / 'wrong' / 'wrong_easy_037.py'
)
...
def test_case_10():
    sol = Solution()
    assert sol.nextGreaterElement([4, 1, 2], [1, 2, 3, 4]) == [-1, 2, 3]

def test_case_11():
    sol = Solution()
    assert sol.nextGreaterElement([4, 1, 2], [4, 3, 2, 1]) == [-1, -1, -1]

def test_case_12():
    sol = Solution()
    assert sol.nextGreaterElement([4, 1, 2], [2, 4, 3, 1]) == [-1, -1, 4]

def test_case_13():
    sol = Solution()
    assert sol.nextGreaterElement([4, 1, 2], [1, 3, 4, 2, 0]) == [-1, 3, -1]

def test_case_14():
    sol = Solution()
    assert sol.nextGreaterElement([4, 1, 2], [1, 3, 4, 2, 1, 3, 4, 2]) == [-1, 3, 3]

def test_case_15():
    sol = Solution()
    assert sol.nextGreaterElement([], [1, 2, 3, 4]) == []
