# Test suite for wrong_medium_047  (slug: lexicographically-smallest-string-after-substring-operation)
import importlib.util, pathlib

_wrong_path = (
    pathlib.Path(__file__).parent.parent
    / 'question_medium' / 'code' / 'wrong' / 'wrong_medium_047.py'
)
...
def test_case_2():
    sol = Solution()
    assert sol.smallestString('acbbc') == 'abaab'

def test_case_3():
    sol = Solution()
    assert sol.smallestString('leetcode') == 'kddsbncd'
