"""
Figure for Table 3 (QuixBugs): Minimal set accuracy using actual LLM
minimal-set predictions (with tests) vs FauxPy top-|GT|. F1 only, one bar
per method.
"""
...
def main():
    ...
    ax.set_ylabel("Score")
    ax.set_title("Minimal Set Accuracy: LLM Minimal-Set Predictions (with tests) vs FauxPy top-|GT| (QuixBugs)")
    ax.grid(axis="y", alpha=0.3)

    plt.tight_layout()
    fig_path = OUT_FIGURES / "figure3_minimal_set_llm.png"
