"""
Does FauxPy (SBFL) localization guidance improve repair over blind (`none`)
repair, holding the repair model fixed? -- direct parallel to
table8_none_vs_fauxpy_gap.py (Refactory).
"""
...
def main():
    table8 = build_table8()
    print("FauxPy-guided vs blind (`none`) repair, per repair model (QuixBugs)\n")
    ...
    ax.set_title("Effect of Adding FauxPy (SBFL) Localization vs Blind Repair (QuixBugs)")
