"""
Headline solve rate by (repair type x model) on QuixBugs -- direct parallel
to table1_solve_rate.py (Refactory). All 40 questions used (no exclusion
needed, unlike Refactory's question 2).
"""
...
from common import OUT_TABLES, OUT_FIGURES, MODELS, TYPES, MODEL_LABELS, TYPE_LABELS, load_records
...
def main():
    ...
    print("Solve rate by repair type x model (QuixBugs, questions 1-40; n=40 per cell)\n")
    ...
    ax.set_title("Repair Solve Rate by Type and Model (QuixBugs, questions 1-40)")
