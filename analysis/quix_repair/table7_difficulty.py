"""
Does solve rate degrade as the actual bug gets more complex? -- direct
parallel to table7_difficulty.py (Refactory). Stratifies solve rate by the
number of ground-truth buggy lines per submission, pooled across all 8
models, on QuixBugs (questions 1-40).
"""
...
def main():
    ...
    print("Solve rate by ground-truth bug-set size (QuixBugs, all 8 models pooled, questions 1-40)\n")
    ...
    ax.set_title("Solve Rate vs. Bug Complexity (QuixBugs, all models pooled)")
