"""
Table 5. Outcome taxonomy over ALL submissions (not just failures), so no
category's share is computed against a shrinking denominator. Categories are
mutually exclusive and always sum to 100% of the 1,348-submission basis:

  already passing (solved, 0 iter)   -- original code already passed; no
                                         repair was needed or attempted
  solved with repair (solved, >=1)   -- a real repair happened
...
def main():
    ...
    print("Outcome taxonomy, share of ALL 1,348 submissions per cell (questions 1,3,4,5)\n")
    ...
    ax.set_title("Outcome Taxonomy by Repair Type (all models pooled)")
