"""
Table 4. Efficiency: among SOLVED submissions only, how many iterations did
it take? Solve rate alone conflates "solves fast" with "barely scrapes by".
"""
...
def main():
    ...
    print("Mean iterations to solve (solved cases only; questions 1,3,4,5)\n")
    ...
    ax.set_title("Repair Efficiency by Type and Model (Refactory, solved cases only)")
